<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="extra.aspx.cs" Inherits="milestone3esra.extra" %>
...
<body>
    ...
    <div class="container">
        <h2>view the extra amount from your payment</h2>
        ...
        <asp:Label ID="Label2" runat="server" Text="Enter Plan Name:"></asp:Label>    

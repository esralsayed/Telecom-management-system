...
select dbo.[AccountLoginValidation]('19','vvvv')
--//////////////////////////////////////////////////////////////////////////////////////////////////////
------------------------------------------------------------------------------------------------------------
----------------------------------------Consumption-----------------------
...
select dbo.[Remaining_plan_amount]('19','serv2')
...
SELECT dbo.[Extra_plan_amount]('19', 'serv2');
select * from Service_plan s inner join process_payment pp
on s.planID = pp.planID inner join payment p 
on pp.paymentID = p.paymentID

declare @plan_id int, @payment_id int
Select s.planID, p.paymentID from Service_plan s inner join process_payment pp
on s.planID = pp.planID inner join payment p 
on pp.paymentID = p.paymentID
where s.name = 'serv2' and p.mobileNo = '19' and p.status='successful'
...
Exec Top_Successful_Payments @mobile_num = '19'
...
VALUES (5,'John', 'Doe', 'john.doe@example.com', '123 Main St', '1990-01-01');
INSERT INTO Customer_Profile
VALUES (6,'mohsen', 'hos', 'mohsen.hos@example.com', '123 Main St', '1990-01-01');




-- Insert into Customer_Account
INSERT INTO Customer_Account values('12345','pass22',500.0, 'Postpaid' , '2024-02-02', 'Active', 200, 5)
INSERT INTO Customer_Account values('19','vvvv',600.0, 'Postpaid' , '2024-02-02', 'Active', 200, 5)
INSERT INTO Customer_Account values('20','vvvv',100, 'Postpaid' , '2024-02-02', 'Active', 200, 6)
INSERT INTO Customer_Account values('20','vvvv',100, 'Postpaid' , '2024-02-02', 'Active', 200, 6)

insert into Benefits values ('bla','05-06-2024','active','12345')

select * from Benefits

insert into Service_Plan values('serv1',100,200,1000,20,'hehe')
insert into Service_Plan values('serv2',100,200,1000,20,'hehe')
insert into Subscription values('19',2,'05-06-2024','active')
insert into Subscription values('19',4,'05-06-2024','active')
insert into Subscription values('20',4,'05-06-2024','active')
insert into Subscription values('20',2,'11-06-2024','active')

select * from Service_plan
truncate table service_plan
delete from Subscription
where mobileNo='20'
insert into Payment values(200.1,'02-04-2024','cash','successful','19')
insert into Payment values(20,'02-04-2024','cash','successful','19')
insert into Payment values(20,'02-04-2024','cash','successful','19')
insert into Payment values(300,'02-04-2024','cash','successful','19')
insert into Payment values(300,'02-04-2024','cash','successful','20')
...
insert into process_payment values(3,2)
insert into process_payment values(5,4)
insert into process_payment values(6,4)
insert into process_payment values(7,4)
select * from Payment
select * from process_payment
select * from Service_plan


SELECT dbo.[Remaining_plan_amount]('19', 'serv1');
SELECT dbo.[Extra_plan_amount]('19', 'serv2');
SELECT dbo.[Extra_plan_amount]('20', 'serv2');
SELECT dbo.[function_extra_amount](6,4);
...
VALUES
('12345', 'Unable to recharge wallet', 1, 'Open'),
('12345', 'Incorrect cashback credited', 2, 'In Progress'),
('12345', 'Unable to access subscription details', 1, 'Open')

select * from Technical_support_ticket

insert into Voucher values(50,'05-06-2025',500,'12345','01-02-2024',1)
insert into Voucher values(100,'05-06-2025',600,'12345','01-02-2024',1)
insert into Voucher values(150,'05-06-2025',400,'12345','01-02-2024',1)
insert into shop values('happy shop','cat 1')
insert into shop values('happy2','dog 1')
...
select * from Plan_Usage
insert into Plan_Usage values('02-01-2024','09-11-2024',100,500,200,19,2);
select * from Subscription

insert into Wallet values(100,'dollar','01-11-2024',5,'12345')
insert into Wallet values(100,'dollar','01-11-2024',5,'19')

select * from Wallet

select * from transfer_money
insert into transfer_money values(1,2,10,'02-02-2024');

select * from E_shop
insert into E_shop values(1,'@hellokitty',10)
insert into E_shop values(2,'@spongebob',9)
